...
int find_first_number(const string&);
int col_to_num(string& s);
...
void excel_format_to_row_col(string& s){
    int first_number = find_first_number(s);
...
int find_first_number(const string& s) {
